...
@EnableJpaRepositories(basePackages = "vn.repository")
...
//    }
    ...
    public DriverManagerDataSource getDataSource() {
        ...
        datasource.setUrl("jdbc:mysql://localhost:3306/ung_dung_blog?useSSL=false&useUnicode=true&characterEncoding=utf8");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan(new String[]{"vn.entity"});

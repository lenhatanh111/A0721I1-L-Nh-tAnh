...
<center>
    ...
    <form method="post">
        ...
        <div class="input-group flex-nowrap">
            <span class="input-group-text">id_card</span>
            <input type="text" class="form-control" placeholder="id_card" aria-label="Username" aria-describedby="addon-wrapping" name="cmnd">
        </div>
        <div class="input-group flex-nowrap">
        ...
        <div class="input-group flex-nowrap">
            <span class="input-group-text">customer_type</span>
            <select name="customer_type_id">
                <c:forEach var="customer_type" items="${list}">
                    <option value="${customer_type.customer_type_id}">

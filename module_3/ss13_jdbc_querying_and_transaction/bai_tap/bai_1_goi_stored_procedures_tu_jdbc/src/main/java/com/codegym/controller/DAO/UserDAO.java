package com.codegym.controller.DAO;

import com.codegym.controller.model.User;
...
public class UserDAO implements IUserDAO{
    ...
    private static final String VIEW_ALL_USER = "call view_all_user();";
    ...
    public List<User> selectAllUsers() {
      ...
      Connection connection = getConnection();
        try {
            CallableStatement callableStatement = connection.prepareCall(VIEW_ALL_USER);
